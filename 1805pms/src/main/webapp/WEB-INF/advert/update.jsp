			...
			<tbody id="tab_1">
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text"  class="required" name="title" id="title" onblur="chktitle()"  value="${advert.title }"/>	
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<textarea rows="10" cols="100" class="required" name="content" id="content" onblur="chkcontent()" >${advert.content }</textarea>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="crman" id="crman" onblur="chkcrman()" value="${advert.crman }"/>
